...
<header id="portfolio" style="background-color:#95a5a6">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
      ...
      <button class="w3-button w3-white w3-hide-small"><i class="fa fa-map-pin w3-margin-right"></i>Events</button>
    </div>
    </div>
  </header>
...
<div class="card">
  <img src="studentPic/<?php echo $result['picProfile']; ?>" alt="" style="width:50%">
  <h1 style="font-size:30px;"><?php echo $result['sName']; ?></h1>
  <p class="title"><?php echo $result['faculty']; ?></p>
  <p>Universiti Malaysia Pahang</p>
  <p><?php echo $result['sPhoneNo']; ?></p>
  <p><?php echo $result['sEmail']; ?></p>
