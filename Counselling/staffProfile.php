...
<div class="card">
  <img src="staffPic/<?php echo $resultStaff['image']; ?>" alt="" style="width:50%">
  <h1 style="font-size:30px;"><?php echo $resultStaff['staffName']; ?></h1>
  <p class="title"><?php echo $resultStaff['officeRoom']; ?></p>
  <p>Universiti Malaysia Pahang</p>
  <p><?php echo $resultStaff['phoneNo']; ?></p>
  <p><?php echo $resultStaff['email']; ?></p>
