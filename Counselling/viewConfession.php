...
<header id="portfolio" style="background-color:#95a5a6">
  ...
  <form align="center" background="http://www.designbolts.com/wp-content/uploads/2013/02/Grey-cement-Seamless-Pattern-For-Website-Background.jpg" align="center" name="confession" method="post" action="viewConfession.php">




<h2 align="center" style="font-size: 36px; font-weight: bold;"> List of confession</h2><br><br>

<div class="confessList" align="center" style="width:900px">	
	<table align="center" border="1px" cellpadding="5px" cellspacing="0">
		<tr style="font-weight:bold;">
			...
			<td>Subject</td>
			<td style="text-align:center;">Confession</td>
			<td>Action</td>
			</b>
		</tr>
		<?php 
			$studentConfession = $_SESSION['studentID'];
			//echo $studentConfession;
			
				$confessData = "select confessionID, studentID, date, typeConfession, subject, confession 
								from confession where studentID='$studentConfession'";
				$result1 = mysqli_query($con, $confessData);
		...
		<tr>
			...
			<td>
				<a href="viewFeedback.php?confessionID=<?=$row['confessionID'];?>">View Feedback</a>
			</td>
		</tr>
		<?php
			}
...
<?php
			...
			//$confessData = $con->prepare("select confessionID, studentID, date, typeConfession, subject, confession from confession where studentID='$studentConfession'");
			//$confessData->execute();
