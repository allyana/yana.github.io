...
if(isset($_REQUEST["loginCouns"]))
{
	  $staffID=$_REQUEST["staffID"];
	  $password=$_REQUEST["password"];
	  $query=mysql_query("select staffName, image from counsellor where staffID='$staffID' && password='$password'");
...
<div id="main.wrapper">
		...
		<h3><center><form class="myform" action="" method="post">
			...
			<input id="staffID" name="staffID" type="text" class="inputvalues" placeholder="Type your username"/><br>
			<label> Password: </label><br>
			<input id="password" name="password" type="password" class="inputvalues" placeholder=""/><br>
			<input name="loginCouns" type="submit" id="loginButn" value="Login"/><br><br>
