...
<form id="command" name="dass1" method="get" action="dass13To15.php">

<div align="center">
	 <label style="float:center; font-weight:bold; font-size:20px;"> 4 / 7 Page</label><br><br>
     ...
     <table align="center" >
     	<tbody>
		<tr>
     		<th class="statement">Statements 10 to 12</th>
     		<th>0</th>
     		<th>1</th>
     		<th>2</th>
     		<th>3</th>
     	...
     	<tr>
     		<td class="statement">10. I felt that I had nothing to look forward to. </td>
     		<td><input id="depression31" name="depression3" type="radio" value="0"/></td>
       		<td><input id="depression32" name="depression3" type="radio" value="1"/></td>
       		<td><input id="depression33" name="depression3" type="radio" value="2"/></td>
      		<td><input id="depression34" name="depression3" type="radio" value="3"/></td>
     	</tr>
		<tr>
     		<td class="statement">11. I found myself getting agitated. </td>
     		<td><input id="stress41" name="stress4" type="radio" value="0"/></td>
       		<td><input id="stress42" name="stress4" type="radio" value="1"/></td>
       		<td><input id="stress43" name="stress4" type="radio" value="2"/></td>
      		<td><input id="stress44" name="stress4" type="radio" value="3"/></td>
     	</tr>
     	<tr>
     		<td class="statement">12. I found it difficult to relax.</td>
     		<td><input id="stress51" name="stress5" type="radio" value="0"/></td>
       		<td><input id="stress52" name="stress5" type="radio" value="1"/></td>
       		<td><input id="stress53" name="stress5" type="radio" value="2"/></td>
      		<td><input id="stress54" name="stress5" type="radio" value="3"/></td>
     	</tr><br><br>
...
<button formaction="dass7To9.php" class="button button1" style="font-size:18px; align:center;"> << Previous </button>
<button onclick="window.location.href='dass13To15.php'" class="button button2" style="font-size:18px; align:center;"> Next >> </button>
