...
<header id="portfolio" style="background-color:#95a5a6">
  ...
  <div align="center" class="w3-row-padding w3-padding-16" id="about">
    <div class="w3-col m6">
      <img src="images/admin.png" alt="Me" style="width:50%"><br><br>
    ...
    <div class="w3-col m6">
      <img src="images/admin.png" alt="Me" style="width:50%"><br><br>
	  <form action="counselorIndex.php">
	  <input type="submit" value="COUNSELLOR">
	  </form>
    </div>
  </div>
