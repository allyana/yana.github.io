...
<form id="command" name="dass1" method="post" action="dass4To6.php">

<div align="center">
	 <label style="float:center; font-weight:bold; font-size:20px;"> 1 / 7 Page</label><br><br>

	 <p align="left"><strong>The rating scale is as follow:</strong></p>
     ...
     <table align="center" >
     	<tbody>
		<tr>
     		<th class="statement">Statements 1 to 3</th>
     		<th>0</th>
     		<th>1</th>
     		<th>2</th>
     		<th>3</th>
     	...
     	<tr>
     		<td class="statement">1. I found it hard to wind down.</td>
     		<td><input id="stress11" name="stress1" type="radio" value="0"/></td>
     		<td><input id="stress12" name="stress1" type="radio" value="1"/></td>
     		<td><input id="stress13" name="stress1" type="radio" value="2"/></td>
     		<td><input id="stress14" name="stress1" type="radio" value="3"/></td>
     	</tr>
     	<tr>
     		<td class="statement">2. I was aware of dryness of my mouth.</td>
     		<td><input id="anxiety11" name="anxiety1" type="radio" value="0"/></td>
       		<td><input id="anxiety12" name="anxiety1" type="radio" value="1"/></td>
       		<td><input id="anxiety13" name="anxiety1" type="radio" value="2"/></td>
      		<td><input id="anxiety14" name="anxiety1" type="radio" value="3"/></td>
     	</tr>
     	<tr>
     		<td class="statement">3. I couldn&#39;t seem to experience any positive feeling at all</td>
     		<td><input id="depression11" name="depression1" type="radio" value="0"/></td>
       		<td><input id="depression12" name="depression1" type="radio" value="1"/></td>
       		<td><input id="depression13" name="depression1" type="radio" value="2"/></td>
      		<td><input id="depression14" name="depression1" type="radio" value="3"/></td>
     	</tr>
...
<button onclick="window.location.href='dass21.php'" class="button" style="font-size:18px; align:center;"> Next >></button>
