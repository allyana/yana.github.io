...
<form id="command" name="dass1" method="get" action="dass16To18.php">

<div align="center">
	 <label style="float:center; font-weight:bold; font-size:20px;"> 5 / 7 Page</label><br><br>
     ...
     <table align="center" >
     	<tbody>
		<tr>
     		<th class="statement">Statements 13 to 15</th>
     		<th>0</th>
     		<th>1</th>
     		<th>2</th>
     		<th>3</th>
     	...
     	<tr>
     		<td class="statement">13. I felt down hearted and blue. </td>
     		<td><input id="depression41" name="depression4" type="radio" value="0"/></td>
       		<td><input id="depression42" name="depression4" type="radio" value="1"/></td>
       		<td><input id="depression43" name="depression4" type="radio" value="2"/></td>
      		<td><input id="depression44" name="depression4" type="radio" value="3"/></td>
     	</tr>
		<tr>
     		<td class="statement">14. I was intolerant of anything that kept me from getting on with what I was doing. </td>
     		<td><input id="stress61" name="stress6" type="radio" value="0"/></td>
       		<td><input id="stress62" name="stress6" type="radio" value="1"/></td>
       		<td><input id="stress63" name="stress6" type="radio" value="2"/></td>
      		<td><input id="stress64" name="stress6" type="radio" value="3"/></td>
     	</tr>
		<tr>
     		<td class="statement">15. I felt I was close to panic. </td>
     		<td><input id="anxiety51" name="anxiety5" type="radio" value="0"/></td>
       		<td><input id="anxiety52" name="anxiety5" type="radio" value="1"/></td>
       		<td><input id="anxiety53" name="anxiety5" type="radio" value="2"/></td>
      		<td><input id="anxiety54" name="anxiety5" type="radio" value="3"/></td>
     	</tr><br><br>
...
<button formaction="dass10To12.php" class="button button1" style="font-size:18px; align:center;"> << Previous </button>
<button onclick="window.location.href='dass16To18.php'" class="button button2" style="font-size:18px; align:center;"> Next >> </button>
