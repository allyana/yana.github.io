...
<form id="command" name="dass1" method="post" action="dassResult.php">

<div align="center">
	 <label style="float:center; font-weight:bold; font-size:20px;"> 7 / 7 Page</label><br><br>
     ...
     <table align="center" >
     	<tbody>
		<tr>
     		<th class="statement">Statements 19 to 21</th>
     		<th>0</th>
     		<th>1</th>
     		<th>2</th>
     		<th>3</th>
     	...
     	<tr>
     		<td class="statement">19. I was of the action of my heart in the absence of physical exertion (e.g. sense of heart rate increase, heart missing a beat). </td>
     		<td><input id="anxiety61" name="anxiety6" type="radio" value="0"/></td>
       		<td><input id="anxiety62" name="anxiety6" type="radio" value="1"/></td>
       		<td><input id="anxiety63" name="anxiety6" type="radio" value="2"/></td>
      		<td><input id="anxiety64" name="anxiety6" type="radio" value="3"/></td>
     	</tr>
		<tr>
     		<td class="statement">20. I felt I scared without any good reason. </td>
     		<td><input id="anxiety71" name="anxiety7" type="radio" value="0"/></td>
       		<td><input id="anxiety72" name="anxiety7" type="radio" value="1"/></td>
       		<td><input id="anxiety73" name="anxiety7" type="radio" value="2"/></td>
      		<td><input id="anxiety74" name="anxiety7" type="radio" value="3"/></td>
     	</tr>
		<tr>
     		<td class="statement">21. I felt that life was meaningless. </td>
     		<td><input id="depression71" name="depression7" type="radio" value="0"/></td>
       		<td><input id="depression72" name="depression7" type="radio" value="1"/></td>
       		<td><input id="depression73" name="depression7" type="radio" value="2"/></td>
      		<td><input id="depression74" name="depression7" type="radio" value="3"/></td>
     	</tr><br><br>
...
<button onclick="window.location.href='dassResult.php'" align="center" type="submit" name="DASSres" class="button"> Get Result</button>
