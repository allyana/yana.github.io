...
<form id="command" name="dass1" method="get" action="dass7To9.php">

<div align="center">
	 <label style="float:center; font-weight:bold; font-size:20px;"> 2 / 7 Page</label><br><br>
     ...
     <table align="center" >
     	<tbody>
		<tr>
     		<th class="statement">Statements 4 to 6</th>
     		<th>0</th>
     		<th>1</th>
     		<th>2</th>
     		<th>3</th>
     	...
     	<tr>
     		<td class="statement">4. I experienced breathing difficulty <br>&nbsp;(e.g. excessively rapid breathing, breathlessness in the absence of physical exertion).</td>
     		<td><input id="anxiety21" name="anxiety2" type="radio" value="0"/></td>
       		<td><input id="anxiety22" name="anxiety2" type="radio" value="1"/></td>
       		<td><input id="anxiety23" name="anxiety2" type="radio" value="2"/></td>
      		<td><input id="anxiety24" name="anxiety2" type="radio" value="3"/></td>
     	</tr>
     	<tr>
     		<td class="statement">5. I found it difficult to work up the initiative to do things.</td>
     		<td><input id="depression21" name="depression2" type="radio" value="0"/></td>
       		<td><input id="depression22" name="depression2" type="radio" value="1"/></td>
       		<td><input id="depression23" name="depression2" type="radio" value="2"/></td>
      		<td><input id="depression24" name="depression2" type="radio" value="3"/></td>
     	</tr>
     	<tr>
     		<td class="statement">6. I tended to over-react to situations.</td>
     		<td><input id="stress21" name="stress2" type="radio" value="0"/></td>
       		<td><input id="stress22" name="stress2" type="radio" value="1"/></td>
       		<td><input id="stress23" name="stress2" type="radio" value="2"/></td>
      		<td><input id="stress24" name="stress2" type="radio" value="3"/></td>
     	</tr><br><br>
...
<!--<button formaction="dass1To3.php" style="font-size:18px" align="center"> << Previous </a></button>-->
<button formaction="dass1To3.php" class="button button1" style="font-size:18px; align:center;"> << Previous </button>
<button onclick="window.location.href='dass7To9.php'" class="button button2" style="font-size:18px; align:center;"> Next >> </button>
